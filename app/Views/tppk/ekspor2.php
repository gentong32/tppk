...
if ($instansiid <= 2) {
    ...
    $column = 1;
    $table_columns = array("No", "Kabupaten", "Kecamatan", "Nama Sekolah", "NPSN", "Bentuk Pendidikan", "Status Sekolah");
    ...
    $column = 1;
    $table_columns = array("No", "Kecamatan", "Nama Sekolah", "NPSN", "Bentuk Pendidikan", "Status Sekolah");
    foreach ($table_columns as $field) {
        $object->getActiveSheet()->setCellValueByColumnAndRow($column, 5, $field);
        $column++;
    }
