    ...
    <div class="container">
        <div class="left-column">
            ...
            <div class="infologin">
                ...
                Username diisi alamat email yang terdaftar pada SK Satgas.<br><br>
                Password jika baru pertama kali login, diisi dengan NIK dan tanggal lahir Anda (format: NIK_tgl-bln-tahun). <br>
                Contoh:<br>1234567890123456_01-02-2003<br><br>Password dapat diatur ulang setelah berhasil login.
            </div>
        </div>
        <div class="right-column">
            <div class="login-container">
                <h2>Silakan login menggunakan NIK dan tanggal lahir Anda untuk reset password!</h2>
