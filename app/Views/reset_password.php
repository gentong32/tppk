    ...
    <div class="container">
        ...
        <div class="right-column">
            <div class="login-container">
                ...
                <form action="<?= base_url('updatekodereset') ?>" method="POST">
                    <?= csrf_field() ?>
                    Masukkan alamat email yang terdaftar pada SK Satgas
                    ...
                    <div class="btn-container">
                        ...
                        <button type="button" id="batal" class="secondary">Batal</button>
                    </div>
                </form>
            </div>
        </div>
