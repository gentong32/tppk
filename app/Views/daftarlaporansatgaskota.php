...
<div class="content-wrap">
    ...
    <?php if ($kode_wilayah != '000000' && $area) { ?>
        <?= $linkindonesia ?> >> <?= $linkprovinsi ?> >> <?= ($judul) ?>
    <?php } ?>
    ...
    <div style="margin-top: 15px;">
        ...
        <?php } ?>
        <?php if ($indeks == 2) { ?>
            <button class="btn_ijo" onclick="laporandinas();">LAPORAN DINAS PROVINSI</button>
        <?php } ?>
        <?php if ($indeks == 3) { ?>
            <button class="btn_ijo" onclick="laporan();">LAPORAN SATUAN PENDIDIKANs</button>
        <?php } ?>
        <div class="informasi">
