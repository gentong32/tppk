    ...
    <div class="landing-page">
        <div class="form-container">
            ...
            <form action="<?= base_url() ?>inputdata/simpansatgas" method="post" enctype="multipart/form-data">
                <?= csrf_field() ?>
                <input type="hidden" name="id_level_wilayah" value="1">
                    ...
                    <div id="dpropinsi">
                        <select <?= ($sebagai == "dinasprovinsi") ? "disabled" : "" ?> class="single" id="ipropinsi" name="ipropinsi">
                            ...
                            <?php foreach ($namaPropinsi as $row) :
                                $cekkode = "";
                                if ($wilayahsaya == $row->kode_wilayah)
                                    $cekkode = "selected";
                ...
                <div class="form-group">
                    <label for="tanggal_sk">Nomor SK</label>
                    <input type="text" id="nomor_sk" name="nomor_sk" value="">
                </div>
                <div class="form-group">
                    ...
                    <div class="form-group ctim">
                        ...
                        <div id="djenis0">
                            <select class="single" id="idinas0" name="idinas0">
                                ...
                                <option value="21">Dinas Sosial</option>
                                <option value="22">Dinas PPPA</option>
                                <option value="23">Dinas Kesehatan</option>
                                <option value="24">UPTD PPA</option>
                                <option value="25">Kepolisian</option>
                                <option value="26">Balai Pemasyarakatan</option>
                                <option value="27">Fasilitas Kesehatan</option>
                                <option value="28">Fasilitas Rehab Sosial</option>
                                <option value="29">Tokoh Adat / Masyarakat</option>
                                <option value="30">Lembaga Swadaya Masyarakat</option>
